...
public class SalarySchemeController {
    ...
    private void SalarySchemes(ActionEvent event) throws IOException {
        ...
        AnchorPane home_page = (AnchorPane) FXMLLoader.load(getClass().getResource("/controller/EmployeeManagement/SalarySchemes.fxml"));
    ...
    private void Allowances(ActionEvent event) throws IOException {
        ...
        AnchorPane home_page = (AnchorPane) FXMLLoader.load(getClass().getResource("/controller/EmployeeManagement/Allowances.fxml"));
    ...
    private void SystemUsers(ActionEvent event) throws IOException {
        ...
        AnchorPane home_page = (AnchorPane) FXMLLoader.load(getClass().getResource("/controller/EmployeeManagement/SystemUsers.fxml"));
