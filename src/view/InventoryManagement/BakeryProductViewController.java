...
public class BakeryProductViewController implements Initializable {
    @FXML
    ...
    private void dataValidateMessage(){
        ...
        if(!(DataValidation.TextFieldNotEmpty(BPNameTextField)
            ...
            DataValidation.TextFieldNotEmpty(BPNameTextField, BPNameLabel,"Name for Bakery Product is Required");
            DataValidation.TextFieldNotEmpty(BPWeightTextField, BPWeightLabel,"Weight of Product is Required(KG/L)");
            DataValidation.TextFieldNotEmpty(BPDescriptionTextArea, BPDescriptionLabel,"Description about the Product is Required");
            DataValidation.TextFieldNotEmpty(BPPriceTextField, BPPriceLabel, "Price of the Product is Required");
        ...
        if(!( DataValidation.isValidMaximumLength(BPNameTextField.getText(),80)
            ...
            DataValidation.isValidMaximumLength(BPNameTextField.getText(),80, BPNameLabel,"Bakery Product Name is too Long!..");
        ...
        if(!(DataValidation.isValidNumberFormat(BPWeightTextField.getText())
                && DataValidation.isValidNumberFormat(BPPriceTextField.getText()))){
            //Checking for Specific Data Validation
            DataValidation.isValidNumberFormat(BPWeightTextField.getText(), BPWeightLabel,"Product Weight can contain only Digits");
            DataValidation.isValidNumberFormat(BPPriceTextField.getText(), BPPriceLabel, "Product Price can contain only Digits");
        }
    }
    ...
    private void updateData(ActionEvent event)throws Exception{
        ...
        try{
            ...
            AlertPopUp.selectRowToUpdate("Bakery Product");
        }
    ...
    private void deleteData(){
        ...
        try{
            ...
            AlertPopUp.selectRowToDelete("Bakery Product");
        }
    }
