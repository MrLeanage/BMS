...
public class AgencyProductsController implements Initializable {
    ...
    private void dataValidateMessage(){
        ...
        if(!(DataValidation.TextFieldNotEmpty(APProductNameTextBox.getText())
            ...
            DataValidation.TextFieldNotEmpty(APProductNameTextBox, APProductNameLabel,"Agency SalesItem Name is Required");
            DataValidation.TextFieldNotEmpty(APSupplierNameTextBox, APSupplierNameLabel,"Please Select a Agency SalesItem Supplier");
        ...
        if(!DataValidation.isValidMaximumLength(APProductNameTextBox.getText(),80)
            ...
            DataValidation.isValidMaximumLength(APProductNameTextBox.getText(),80, APProductNameLabel,"SalesItem Name is too Long!..");
    ...
    private void selectSupplier(ActionEvent event){
        ...
        loader.setLocation(getClass().getResource("AgencySupplierPopUP.fxml"));

        try{
            loader.load();

        }catch (IOException ex){
            Logger.getLogger(AgencySupplierPopUPController.class.getName()).log(Level.SEVERE, null, ex);
        }
        AgencySupplierPopUPController agencySupplierPopUPController = loader.getController();
    ...
    private void deleteData(){
        ...
        try{
            ...
            AlertPopUp.selectRowToDelete("Agency SalesItem");
        }
