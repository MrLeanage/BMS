...
public class ItemStockViewController implements Initializable {
    ...
    private void selectSupplier(ActionEvent event){
        ...
        try{
            ...
            Logger.getLogger(ItemSupplierPopUPViewController.class.getName()).log(Level.SEVERE, null, ex);
        }
        ItemSupplierPopUPViewController itemSupplierPopUPViewController = loader.getController();
