...
public class ItemSupplierPopUPController implements Initializable {
    ...
    private void loadData() {
        ...
        productSupplierPopUPServices.setSupplierType("'Stock Items'");
    ...
    public void returnSelectedSupplier() throws IOException {
        boolean resultVal = false;
            ...
            ItemStockController itemStockController = loader.getController();
            ...
            resultVal = itemStockController.setSupplier(supplierModel);
