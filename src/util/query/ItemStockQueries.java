...
public class ItemStockQueries {
    ...
    public static final String SEARCH_ITEM_STOCK_DATA_QUERY = "SELECT  IName, IUnitsPerBlock, IBlocks, IWeightOfUnit, IBuyingPricePerUnit, IMinQuantityLimit, IExpireDate, IAddedDate, IAvailableQuantity FROM item";
